...
__builtins__ = {}
__doc__ = None
__file__ = 'c:\\users\\user\\appdata\\local\\programs\\python\\python37\\lib\\site-packages\\sklearn\\svm\\_libsvm_sparse.cp37-win_amd64.pyd'
__name__ = 'sklearn.svm._libsvm_sparse'
